...
export const Button = ({ 
  ...
  const baseStyles = "w-full sm:w-auto px-6 md:px-8 py-3.5 md:py-4 rounded-full font-bold uppercase tracking-widest text-[10px] md:text-xs transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed select-none touch-manipulation";
